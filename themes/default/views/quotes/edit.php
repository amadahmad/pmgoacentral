<script type="text/javascript">
    ...
    $(document).ready(function() {
        <?php if ($inv) { ?>
            ...
            localStorage.setItem('qunote', '<?= $this->sma->decode_html($inv->note); ?>');
            ...
            <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('tax2', $tr, (isset($_POST['tax2']) ? $_POST['tax2'] : $Settings->default_tax_rate2), 'id="qutax2" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("order_tax") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                ?> 
                            </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class="col-sm-12">
                            ...
                            <!--<div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('currency', $cur, (isset($_POST['currency']) ? $_POST['currency'] : $Settings->currency_code), 'id="currency" class="form-control input-tip select" required="required" style="width:100%;" ');
                                    */ ?> 
                                </div>
                            </div>-->
                            <?php if($Owner || $Admin) { ?>
                ...
                <div class="col-sm-12">
                    <div class="control-group table-group">
                        <label class="table-label"><?= lang("quote_items"); ?></label>
                        <div class="controls table-controls">
                            <table id="quTable" class="table items table-striped table-bordered table-condensed table-hover">
                                <thead>
                                    <tr>
                                        <th class="col-sm-4"><?= lang("product_name") . " (" . $this->lang->line("product_code") . ")"; ?></th>
                                        <th class="col-sm-1"><?= lang("net_unit_price"); ?></th>
                                        <th class="col-sm-1"><?= lang("quantity"); ?></th>
                                        <?php
                                        if ($Settings->product_discount) {
                                            echo '<th class="col-sm-1">' . $this->lang->line("discount") . '</th>';
                                        }
                                        ?>
                                        <?php
                                        if ($Settings->tax1) {
                                            echo '<th class="col-sm-2">' . $this->lang->line("product_tax") . '</th>';
                                        }
                                        ?>
