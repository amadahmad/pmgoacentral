<script>
    $(document).ready(function() {
        $('#GCData').dataTable({
            ...
            "aoColumns": [ {"bSortable": false, "mRender": checkbox}, null, null, null, null, null, {"mRender": fsd}, {"bSortable": false} ]
        });
    });
</script>
    ...
    <div class="box-content">  
        <div class="row">            
            <div class="col-lg-12">        
                ...
                <table id="GCData" class="table table-bordered table-hover table-striped" style="margin-bottom: 5px;">
                    <thead>
                        <tr>
