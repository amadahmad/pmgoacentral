...
<script>
    $(document).ready(function() {
        var oTable = $('#RESLData').dataTable({
            ...
            "aoColumns": [{"mRender": fld}, null, null, null, null, {"mRender": currencyFormate}, {"mRender": currencyFormate}, {"bSortable": false, "bVisible": false, "mRender": checkbox}, {"bSortable": false}],
            "fnFooterCallback": function(nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                nCells[5].innerHTML = currencyFormate(parseFloat(sc));
                nCells[6].innerHTML = currencyFormate(parseFloat(gtotal));
            }
        }).fnSetFilteringDelay().columnFilter({aoColumns: [ {type: "text", bRegex: true}, {type: "text", bRegex: true}, {type: "text", bRegex: true}, {type: "text", bRegex: true}, {type: "text", bRegex: true}, null, null, null, null ]});
        ...
        <div class="row">            
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="RESLData" class="table table-bordered table-hover table-striped" style="margin-bottom: 5px;">
                        <thead>
                            <tr>
