            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                    ...
                    <li><a href="<?= site_url('sales/pdf/'.$inv->id) ?>"><i class="fa fa-file-pdf-o"></i> <?= lang('export_to_pdf') ?></a></li>
                        <!--<li><a href="<?= site_url('sales/excel/'.$inv->id) ?>"><i class="fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?></a></li>
                        <li class="divider"></li>
                        <li><a href="<?= site_url('sales/add_payment/'.$inv->id) ?>"><i class="fa fa-money"></i> <?= lang('add_payment') ?></a></li>-->
                    </ul>
                </li>
            </ul>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="well well-sm">
                    <div class="col-sm-4 border-right">
                        ...
                        <div class="col-xs-2"><i class="fa fa-3x fa-hand-o-right padding010 text-muted"></i></div>
                        <div class="col-xs-10">
                    ...
                    <table class="table table-bordered table-hover table-striped print-table">
                                ...
                                <th style="padding-right:20px;"><?= lang("unit_price"); ?></th> 
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <?php 
                                            if($return_sale && $return_items) { $r = 1; echo '<tr class="warning"><th colspan="100%">'.lang('returned_items').'</th></tr>';
                                ...
                                <?php if($paypal->active == "1" && $inv->grand_total != "0.00" ){ 
                                    ...
                                    <div style="width:150px;margin-right:10px;float:left;">
                                        <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                            ...
                                            <input type="hidden" name="custom" value="<?= $inv->reference_no.'__'.$inv->grand_total.'__'.$paypal_fee; ?>">     
                                        </form>
                                    </div>
                                    <?php  } ?>
                                    ...
                                    <?php if($skrill->active == "1" && $inv->grand_total != "0.00" ){ 
                                        ...
                                        ?>
                                        <div style="width:150px;margin-left:10px;float:left;">
                        ...
                        <div class="buttons">
                            <div class="btn-group btn-group-justified">
                                <div class="btn-group"><a href="<?=site_url('sales/view_payments/'.$inv->id)?>" data-toggle="modal" data-target="#myModal" class="tip btn btn-primary tip" title="<?=lang('view_payments')?>"><i class="fa fa-money"></i> <?=lang('view_payments')?></a></div>
                                <div class="btn-group"><a href="<?=site_url('sales/add_payment/'.$inv->id)?>" data-toggle="modal" data-target="#myModal" class="tip btn btn-primary tip" title="<?=lang('add_payment')?>"><i class="fa fa-money"></i> <?=lang('add_payment')?></a></div>
                                <div class="btn-group"><a href="<?=site_url('sales/add_delivery/'.$inv->id)?>" data-toggle="modal" data-target="#myModal" class="tip btn btn-primary tip" title="<?=lang('add_delivery')?>"><i class="fa fa-truch"></i> <?=lang('add_delivery')?></a></div>
                                <div class="btn-group"><a href="<?=site_url('sales/email/'.$inv->id)?>" data-toggle="modal" data-target="#myModal" class="tip btn btn-primary tip" title="<?=lang('email')?>"><i class="fa fa-envelope-o"></i> <?=lang('email')?></a></div>
                                <div class="btn-group"><a href="<?=site_url('sales/pdf/'.$inv->id)?>" class="tip btn btn-primary" title="<?=lang('download_pdf')?>"><i class="fa fa-download"></i> <?=lang('pdf')?></a></div>
                                <div class="btn-group"><a href="<?=site_url('sales/edit/'.$inv->id)?>" class="tip btn btn-warning tip sledit" title="<?=lang('edit')?>"><i class="fa fa-edit"></i> <?=lang('edit')?></a></div>
