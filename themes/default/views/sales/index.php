...
<script>
    $(document).ready(function() {
        var oTable = $('#SLData').dataTable({
            ...
            "aoColumns": [{"bSortable": false, "mRender": checkbox}, {"mRender": fld}, null, null, null, {"mRender": currencyFormate}, {"mRender": currencyFormate}, null, {"bSortable": false}],
        ...
        }).fnSetFilteringDelay().columnFilter({aoColumns: [ null, {type: "text", bRegex: true}, {type: "text", bRegex: true}, {type: "text", bRegex: true}, {type: "text", bRegex: true}, null, null, {type: "text", bRegex: true}, null ]});
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('sales').($warehouse_id ? ' ('.$warehouse->name.')' : ''); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
        ...
        <div class="row">            
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="SLData" class="table table-bordered table-hover table-striped" style="margin-bottom: 5px;">
                        <thead>
                            <tr>
