<script type="text/javascript">
    ...
    $(document).ready(function () {
        <?php if ($inv) { ?>
            ...
            localStorage.setItem('slnote', '<?= $this->sma->decode_html($inv->note); ?>');
            localStorage.setItem('slinnote', '<?= $this->sma->decode_html($inv->staff_note); ?>');
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-warning">
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                        ...
                                        <div class="col-md-12">
                                            <div class="fprom-group"><?php echo form_submit('add_sale', $this->lang->line("submit"), 'id="add_sale" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?><button type="button" class="btn btn-danger" id="reset"><?= lang('reset') ?></button></div></div>            
                                        </div>
                                    </div>
