<script>
    $(document).ready(function () {
        var oTable = $('#POData').dataTable({
            ...
            "aoColumns": [{"bSortable": false, "mRender": checkbox}, {"mRender": fld}, null, null, {"mRender": currencyFormate}, {"mRender": currencyFormate}, null, {"bSortable": false}],
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                nCells[4].innerHTML = formatMoney(total);
                nCells[5].innerHTML = formatMoney(paid);
            }
        }).fnSetFilteringDelay().columnFilter({aoColumns: [ null, {type: "text", bRegex: true}, {type: "text", bRegex: true}, {type: "text", bRegex: true}, null, null, {type: "text", bRegex: true}, null]});
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-star"></i><?= lang('purchases').' '.($warehouse_id ? '('. $warehouse->name .')' : ''); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
