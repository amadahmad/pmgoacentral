<script type="text/javascript">
    ...
    var count = 1, an = 1, DT = <?= $Settings->default_tax_rate ?>, DC = '<?= $default_currency->code ?>', shipping = 0,
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php
                                $post = array('pending' => lang('pending'), 'sent' => lang('sent'), 'received' => lang('received'));
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php
                                                //echo form_hidden('supplier', (isset($_POST['supplier']) ? $_POST['supplier'] : ''), 'class="form-control" id="posupplier" placeholder="' . lang("select") . ' ' . lang("supplier") . '" style="width:100%;"');
                                                //echo form_input('supplier', (isset($_POST['supplier']) ? $_POST['supplier'] : ''), 'class="form-control" id="posupplier" placeholder="' . lang("select") . ' ' . lang("supplier") . '" style="width:100%;"');
                                            ?> 
                                        </div>
                                    </div>
