...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-calendar-o"></i><?= lang('product_quantity_alerts').' '.($warehouse_id ? '('. $warehouse->name .')' : ''); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
        ...
        <div class="row">            
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="PQData" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-condensed table-hover table-striped dfTable">
                        <thead>
                            <tr class="active">
