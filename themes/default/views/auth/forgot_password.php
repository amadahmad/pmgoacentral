            ...
            <div class="row">
                <div id="content" class="col-sm-12 full">
                    <div class="row">
                        ...
                        <div class="login-box">
                            <center><?php if(LOGO) { echo '<img src="'.site_url().'assets/images/'.LOGO.'" alt="'.SITE_NAME.'"  />'; } ?></center>
                        <div style="clear: both; height: 20px;"></div>
                            ...
                            <fieldset class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="controls row">
                                        <div class="input-group col-sm-12"> <span style="position:absolute; right: 7px; top:4px;"><a href="#" class="reload-captcha"><img src="<?=base_url()?>assets/images/reload.png" alt="reload image" /></a></span>
                            ...
                            <a href="<?=site_url('auth/login')?>" class="btn btn-warning col-xs-7"><?php echo lang('back_to_login'); ?></a>
                            <a href="register" class="btn  btn-success col-xs-4 col-xs-offset-1"><?php echo lang('register'); ?></a>
