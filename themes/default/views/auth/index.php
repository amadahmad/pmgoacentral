...
<script>
    $(document).ready(function() {
        var oTable = $('#UsrTable').dataTable({
            ...
            "aoColumns": [ {"bSortable": false, "mRender": checkbox}, null, null, null, null, null, {"mRender": user_status}, {"bSortable": false}]
        }).fnSetFilteringDelay().columnFilter({aoColumns: [
                null, {type: "text", bRegex: true}, {type: "text", bRegex: true}, {type: "text", bRegex: true}, {type: "text", bRegex: true}, {type: "text", bRegex: true}, null, null
            ]});
    });
</script>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('auth/create_user'); ?>"><i class="fa fa-plus-circle"></i> <?= lang("add_customer"); ?></a></li>
