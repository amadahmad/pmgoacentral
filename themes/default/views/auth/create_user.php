                    ...
                    <div class="col-md-12">
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <?php echo form_password('password', '', 'class="form-control tip" id="password" required="required" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])^\D.{7,}"'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <?php echo form_password('confirm_password', '', 'class="form-control" id="confirm_password" required="required" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])^\D.{7,}" data-bv-identical="true" data-bv-identical-field="password" data-bv-identical-message="'.lang('pw_not_came').'"'); ?>
                                </div>
                            </div>
                        ...
                        <div class="col-md-5 col-md-offset-1">
                            ...
                            <div class="no">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : ""), 'id="biller" data-placeholder="' . lang("select") . ' ' . lang("biller") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                    ?> 
                                </div>
