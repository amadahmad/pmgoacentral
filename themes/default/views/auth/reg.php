            ...
            <div class="registration-form-div">
                <form>
                    ...
                    <div class="registration-form-action clearfix">
                        ...
                        <button type="submit" class="btn btn-success pull-right">Register Now &nbsp; <i class="fa fa-chevron-right"></i></button>
                ...
                <div class="forgot-content">
                    <form>
                        ...
                        <div class="forget-form-action clearfix">
                            <a class="btn btn-success pull-left" href="#login"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;Back  </a>
                            <button type="submit" class="btn btn-success pull-right">Submit &nbsp;&nbsp; <i class="fa fa-chevron-right"></i></button>
                        </div>
                    </form>
                </div>
            </div>
