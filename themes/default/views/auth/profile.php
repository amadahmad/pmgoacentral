                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="no">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : ''), 'id="warehouse" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("warehouse") . '" required="required" style="width:100%;" ');
                                                                        ?> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php echo form_password('new_password', '', 'class="form-control" id="new_password" required="required" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])^\D.{7,}"'); ?>
                                                <span class="help-block"><?=lang('pasword_hint')?></span>
                                            </div>

                                            <div class="form-group">
                                                <?php echo lang('confirm_password', 'new_password_confirm'); ?> <br />
                                                <?php echo form_password('new_password_confirm', '', 'class="form-control" id="new_password_confirm" required="required" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])^\D.{7,}" data-bv-identical="true" data-bv-identical-field="password" data-bv-identical-message="'.lang('pw_not_came').'"'); ?>
                        ...
                        <div class="row">            
                            <div class="col-lg-12">
                                <div class="col-md-5">
                                    ...
                                    <?php echo form_open_multipart("auth/update_avatar", $attrib); ?>
                                    <div class="form-group">
