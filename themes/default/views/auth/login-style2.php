...
<html>
    <head>
        ...
        <style>
            ...
            .recaptchatable #recaptcha_response_field { height: 30px; border-right: 1px solid #CCA940 !important; }
        </style>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
			    ...
			    <center><?php if($Settings->logo2) { echo '<img src="'.site_url().'assets/images/'.$Settings->logo2.'" alt="'.$Settings->site_name.'" style="margin-bottom:10px;" />'; } ?></center>
                                ...
                                <div class="form-group">
                                    <div class="controls row">
                                        <div class="input-group col-sm-12">	
                                            <input type="email" id="identity" name="identity" placeholder="<?=lang('email')?>" class="form-control" required="required" />
                                    ...
                                    <div class="controls row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    ...
                                                    <span class="input-group-addon"><a href="#" class="reload-captcha"><i class="fa fa-refresh"></i></a></span>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <a href="forgot_password" class="btn btn-warning col-xs-<?=$allow_reg ? 7 : 12;?>"><?php echo lang('forgot_pw'); ?></a>
                            <?php if($allow_reg) { ?><a href="register" class="btn btn-success col-xs-4 col-xs-offset-1"><?php echo lang('register'); ?></a><?php } ?>
