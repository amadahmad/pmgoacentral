...
<html>
    <head>
        ...
        <style>
            ...
            .tab-wrapper { max-width: 1000px; margin: 0 auto; }
            .table td { text-align: center; }
            h4 { margin:5px; padding:0; }
            @media print {
                .table td { border-color: #F9F9F9 !important; }
                .tab-wrapper { width: auto !important; }
                h3 { margin-top: 0; }
    ...
    <body>
        <div class="tab-wrapper">
            <div class="well"><span style="margin-top:15px; display: block;"><div class="btn-group">
                            ...
                            <a class="btn btn-danger" onclick="javascript:window.close()"><i class="fa fa-times"></i> <?=lang('close'); ?></a>
                    </div></span></div>
            <?= $table; ?>
            <div class="well"><span style="margin-top:15px; display: block;"><div class="btn-group">
                            <a class="btn btn-success" href="<?=site_url()?>"><i class="fa fa-home"></i> <?=lang('home')?></a>
