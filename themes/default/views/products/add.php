...
<?= lang("alert_quantity", "alert_quantity") ?>
                    ...
                    <div class="form-group standard">
                        ...
                        <div class="row" id="supplier-con"><div class="col-md-8 col-sm-8 col-xs-8">
                                <?php
                                echo form_input('supplier', (isset($_POST['supplier']) ? $_POST['supplier'] : ''), 'class="form-control ' . ($product ? '' : 'suppliers') . '" id="supplier" placeholder="' . lang("select") . ' ' . lang("supplier") . '" style="width:100%;"')
                                ?></div>
