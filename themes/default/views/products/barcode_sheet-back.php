    ...
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('#category').change(function() {
                    window.location.replace("<?php echo site_url('products/barcode_sheet'); ?>/" + $(this).val());
                    return false;
                });
            });
        </script>
        <style>
            ...
            @media print
            {
                ...
                h3 { margin-top: 0; }
                .container p, .pagination, .well { display: none; }
            }
        </style>
    </head>
    <body>
        <div class="container">
            <div class="well">
                <h2><?php echo $Settings->site_name . ' - ' . $page_title; ?></h2>
                <div class="col-md-6 col-md-offset-3">
                    ...
                    echo form_dropdown('category', $cat, (isset($_GET['category_id']) ? $_GET['category_id'] : ""), 'class="tip chzn-select form-control" id="category" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("category") . '" required="required" data-error="' . $this->lang->line("category") . ' ' . $this->lang->line("is_required") . '"');
                    ?> 
                </div>
