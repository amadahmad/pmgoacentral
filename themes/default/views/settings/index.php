                ...
                <div class="row">            
                    <div class="col-lg-12">
                        <fieldset class="scheduler-border">
                            ...
                            <div class="col-md-4"><div class="form-group">
                                        <label class="control-label" for="currency"><?php echo $this->lang->line("default_currency"); ?></label>
                            ...
                            <div class="col-md-4"><div class="form-group">
                                <label class="control-label" for="email"><?php echo $this->lang->line("default_email"); ?></label>
                            ...
                            <div class="col-md-4"><div class="form-group">
                                <label class="control-label" for="customer_group"><?php echo $this->lang->line("default_customer_group"); ?></label>
                                <div class="controls"> <?php
                            ...
                            <div class="col-md-4"><div class="form-group">
                                ...
                                <div class="col-md-4"><div class="form-group">
                                    <label class="control-label" for="captcha"><?php echo $this->lang->line("login_captcha"); ?></label>
                                    <div class="controls">
                                        <?php
                                ...
                                <div class="col-md-4"><div class="form-group">
                                    <label class="control-label" for="rows_per_page"><?php echo $this->lang->line("rows_per_page"); ?></label>
                                ...
                                <div class="col-md-4"><div class="form-group">
                                    <label class="control-label" for="dateformat"><?php echo $this->lang->line("dateformat"); ?></label>
                                    <div class="controls">
                                        <?php
                                ...
                                <div class="col-md-4"><div class="form-group">
                                    <label class="control-label" for="timezone"><?php echo $this->lang->line("timezone"); ?></label>
                                    <div class="controls"> <?php echo form_input('timezone', $Settings->timezone, 'class="form-control tip" id="timezone" required="required"'); ?> </div>
                                </div></div>
                                <div class="col-md-4"><div class="form-group">
                                    ...
                                    <div class="col-md-4"><div class="form-group">
                                        <label class="control-label" for="warehouse"><?php echo $this->lang->line("default_warehouse"); ?></label>
                                        <div class="controls"> <?php
                                ...
                                <fieldset class="scheduler-border">
                                    ...
                                    <div class="col-md-4"><div class="form-group">
                                        <label class="control-label" for="racks"><?php echo $this->lang->line("racks"); ?></label>
                                        <div class="controls">
                                            <?php
                                    ...
                                    <div class="col-md-4"><div class="form-group">
                                        <label class="control-label" for="attributes"><?php echo $this->lang->line("attributes"); ?></label>
                                        <div class="controls">
                                            <?php
                                    ...
                                    <div class="col-md-4"><div class="form-group">
                                        <label class="control-label" for="product_expiry"><?php echo $this->lang->line("product_expiry"); ?></label>
                                        <div class="controls">
                                            <?php
                                    ...
                                    <div class="col-md-4"><div class="form-group">
                                        <label class="control-label" for="image_size"><?php echo $this->lang->line("image_size"); ?> (Width : Height) *</label>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <?php echo form_input('iwidth', $Settings->iwidth, 'class="form-control tip col-md-6" id="iwidth" placeholder="image width" required="required"'); ?>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="col-md-4"><div class="form-group">
                                            <label class="control-label" for="thumbnail_size"><?php echo $this->lang->line("thumbnail_size"); ?> (Width : Height) *</label>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <?php echo form_input('twidth', $Settings->twidth, 'class="form-control tip col-md-6" id="twidth" placeholder="thumbnail width" required="required"'); ?>
                                                </div>
                                                <div class="col-md-6">
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="overselling"><?php echo $this->lang->line("over_selling"); ?></label>
                                                <div class="controls">
                                                    <?php
                                                    $opt = array(1 => $this->lang->line('yes'), 0 => $this->lang->line('no'));
                                            ...
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="reference_format"><?php echo $this->lang->line("reference_format"); ?></label>
                                                <div class="controls">
                                                    <?php
                                                    $ref = array(1 => $this->lang->line('prefix_year_no'), 2 => $this->lang->line('prefix_month_year_no'));
                                            ...
                                            <div class="col-md-4"><div class="form-group">
                                                ...
                                                <?php $tr['0'] = $this->lang->line("disable");
                                            ...
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="product_discount"><?php echo $this->lang->line("product_level_discount"); ?></label>
                                                <div class="controls">
                                                    <?php
                                            ...
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="detect_barcode"><?php echo $this->lang->line("auto_detect_barcode"); ?></label>
                                                <div class="controls">
                                                    <?php
                                            ...
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="bc_fix"><?php echo $this->lang->line("bc_fix"); ?></label>
                                                <div class="controls"> <?php echo form_input('bc_fix', $Settings->bc_fix, 'class="form-control tip" required="required" id="bc_fix"'); ?> </div>
                                            </div></div>
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="item_addition"><?php echo $this->lang->line("item_addition"); ?></label>
                                                <div class="controls">
                                                    <?php
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <div class="col-md-4"><div class="form-group">
                                                ...
                                                <div class="controls"> <?php echo form_input('sales_prefix', $Settings->sales_prefix, 'class="form-control tip" id="sales_prefix" required="required"'); ?> </div>
                                            </div></div>
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="return_prefix"><?php echo $this->lang->line("return_prefix"); ?></label>
                                                <div class="controls"> <?php echo form_input('return_prefix', $Settings->return_prefix, 'class="form-control tip" id="return_prefix" required="required"'); ?> </div>
                                            </div></div>
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="payment_prefix"><?php echo $this->lang->line("payment_prefix"); ?></label>
                                                <div class="controls"> <?php echo form_input('payment_prefix', $Settings->payment_prefix, 'class="form-control tip" id="payment_prefix" required="required"'); ?> </div>
                                            </div></div>
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="delivery_prefix"><?php echo $this->lang->line("delivery_prefix"); ?></label>
                                                <div class="controls"> <?php echo form_input('delivery_prefix', $Settings->delivery_prefix, 'class="form-control tip" id="delivery_prefix" required="required"'); ?> </div>
                                            </div></div>
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="quote_prefix"><?php echo $this->lang->line("quote_prefix"); ?></label>
                                                <div class="controls"> <?php echo form_input('quote_prefix', $Settings->quote_prefix, 'class="form-control tip" id="quote_prefix" required="required"'); ?> </div>
                                            </div></div>
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="purchase_prefix"><?php echo $this->lang->line("purchase_prefix"); ?></label>
                                                <div class="controls"> <?php echo form_input('purchase_prefix', $Settings->purchase_prefix, 'class="form-control tip" id="purchase_prefix" required="required"'); ?> </div>
                                            </div></div>
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="transfer_prefix"><?php echo $this->lang->line("transfer_prefix"); ?></label>
                                                <div class="controls"> <?php echo form_input('transfer_prefix', $Settings->transfer_prefix, 'class="form-control tip" id="transfer_prefix" required="required"'); ?> </div>
                                            </div></div>
                                        </fieldset>
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="decimals"><?php echo $this->lang->line("decimals"); ?></label>
                                                <div class="controls"> <?php
                                            ...
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="decimals_sep"><?php echo $this->lang->line("decimals_sep"); ?></label>
                                                <div class="controls"> <?php
                                            ...
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="thousands_sep"><?php echo $this->lang->line("thousands_sep"); ?></label>
                                                <div class="controls"> <?php
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <div class="col-md-4"><div class="form-group">
                                                <label class="control-label" for="protocol"><?php echo $this->lang->line("email_protocol"); ?></label>
                                                <div class="controls"> <?php
                                                ...
                                                <div class="col-md-12">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label" for="smtp_host"><?php echo $this->lang->line("smtp_host"); ?></label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label" for="smtp_user"><?php echo $this->lang->line("smtp_user"); ?></label>
                                                            <div class="controls"> <?php echo form_input('smtp_user', $Settings->smtp_user, 'class="form-control tip" id="smtp_user"'); ?> </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label" for="smtp_pass"><?php echo $this->lang->line("smtp_pass"); ?></label>
                                                            <div class="controls"> <?php echo form_password('smtp_pass', $smtp_pass, 'class="form-control tip" id="smtp_pass"'); ?> </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label" for="smtp_port"><?php echo $this->lang->line("smtp_port"); ?></label>
