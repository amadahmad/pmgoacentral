<div class="box">
    ...
    <div class="box-content">  
        <div class="row">            
            <div class="col-lg-12">
			    ...
			    <li class=""><a href="#forgot_password"><?= lang('forgot_password') ?></a></li>
                            <li class="dropdown">
				<a data-toggle="dropdown" class="dropdown-toggle" id="more" href="#">More <b class="caret"></b></a>
			...
			<div class="tab-content">
				...
				<input type="submit" name="submit" class="btn btn-primary" value="<?= lang('save'); ?>" style="margin-top:15px;"/>
		...
		<?=lang('new_user')?> <pre>{client_name} {email} {password} </pre>
                <?=lang('forgot_password')?> <pre>{user_name} {email} {reset_password_link}</pre>
                <?=lang('activate_email')?> <pre>{user_name} {email} {activation_link}</pre>
                <?=lang('orders')?> &amp; <?=lang('payments')?> <pre>{company} {contact_person} {reference_number}</pre>
