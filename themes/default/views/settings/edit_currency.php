...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form'); echo form_open("system_settings/edit_currency/" . $id, $attrib); ?>  
        <div class="modal-body">
            <p><?= lang('enter_info'); ?></p>

            <div class="form-group">
                <label class="control-label" for="code"><?php echo $this->lang->line("currency_code"); ?></label>
                <div class="controls"> <?php echo form_input('code', $currency->code, 'class="form-control" id="code" required="required"'); ?> </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <label class="padding-left-10" for="auto_update"><?php echo $this->lang->line("auto_update_rate"); ?></label>
            </div>
            <?php } ?>
        </div>
