...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form'); echo form_open("system_settings/add_currency", $attrib); ?>  
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="controls"> <?php echo form_input('rate', '', 'class="form-control" id="rate" required="required"'); ?> </div>
            </div>	 
            <div class="form-group">
