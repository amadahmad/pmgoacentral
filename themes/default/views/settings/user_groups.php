...
<div class="box">
    ...
    <div class="box-content">  
		...
		<div class="table-responsive">
                    <table id="GPData" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped" style="margin-bottom: 5px;">
                        <thead>
			<tr>
			...
			<?php foreach ($groups as $group): ?>
    			<tr>
    			    ...
    			    <td style="text-align:center;"><?php echo '<a class="tip" title="' . $this->lang->line("change_permissions") . '" href="' . site_url('system_settings/permissions/'.$group->id) . '"><i class="fa fa-tasks"></i></a> <a class="tip" title="' . $this->lang->line("edit_group") . '" data-toggle="modal" data-target="#myModal" href="' . site_url('system_settings/edit_group/'.$group->id) . '"><i class="fa fa-edit"></i></a> <a class="tip" title="' . $this->lang->line("delete_group") . '" href="' . site_url('system_settings/delete_group/'.$group->id) . '"><i class="fa fa-trash-o"></i></a>'; ?></td>
    			</tr>
<?php endforeach; ?>
		    </tbody>
		</table>
