 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'saleem-facilitator_api1.tecdiary.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '1405304892' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31AcvmDmbNIqld1Dh0WjWcXFjJeFOF' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['ApplicationID'] = $config['Sandbox'] ? 'SANDBOX_APP_ID_GOES_HERE' : 'PRODUCTION_APP_ID_GOES_HERE';

/*
 * PayPal Developer Account Email Address
 * This is the email address that you use to sign in to http://developer.paypal.com
 */
$config['DeveloperEmailAccount'] = 'mian.saleem@yahoo.com';
